...
data class PrintStatement(val value: Expression, val newline: Boolean, override val position: Position? = null) : Statement {
    override fun children(): List<AstNode> = listOf(value)
}
...
interface InputFunction : Expression

data class ReadInt(override val position: Position? = null) : InputFunction
